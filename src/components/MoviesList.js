...
export default class Home extends Component {
	...
	componentDidMount() {
		const page1 = fetch(
			`https://api.themoviedb.org/3/movie/${this.props.type}?api_key=57440f72713333a308e3c60c8ed75e5c&language=en-US&page=1`
		);
		const page2 = fetch(
			`https://api.themoviedb.org/3/movie/${this.props.type}?api_key=57440f72713333a308e3c60c8ed75e5c&language=en-US&page=2`
		);
		Promise.all([
			page1.then(d => d.json()),
			page2.then(d => d.json())
